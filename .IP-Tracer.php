...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mAuthor \033[01;37m:- \033[01;36mclb 09
...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/CLB-09/IP-Tracer.git");
  system("cd ~/ && sudo git clone https://github.com/CLB-09/IP-Tracer.git");
